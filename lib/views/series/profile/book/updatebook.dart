...
class UpdateBook extends StatefulWidget {
  const UpdateBook({
    ...
    required this.oldfile_id,
    required this.olddescription,
    required this.oldpage,
    required this.oldbook_file,
    required this.oldpublish,
  }) : super(key: key);
  ...
  final String oldfile_id;
  final String olddescription;
  final String oldpage;
  final String oldbook_file;
  final String oldpublish;
...
class _UpdateBookState extends State<UpdateBook> {
  ...
  uploadbook() async {
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            ApiConfig.apiUrl() + "book/creator/bookupdate/${widget.oldslug}"));
              ...
              child: Column(
                ...
                children: [
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: NetworkImage(widget.oldthumbnail),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            );
                            ...
                            child: ButtonTheme(
                              ...
                              child: DropdownButton<String>(
                                ...
                                items: filebook?.map((item) {
                                  return DropdownMenuItem(
                                    child: widget.oldfile_id == item["name"]
                                        ? Text(widget.oldfile_id)
                  ...
                  TextFormField(
                    ...
                    onSaved: (e) => title = e!,
                    controller: _title..text = widget.oldtitle,
                    validator: (value) {
                  ...
                  TextFormField(
                    ...
                    onSaved: (e) => price = e!,
                    controller: _price..text = widget.oldprice,
                  ...
                  TextFormField(
                    ...
                    onSaved: (e) => page = e!,
                    keyboardType: TextInputType.number,
                    controller: _page..text = widget.oldpage,
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return "Field is required";
                      }
                  ...
                  TextFormField(
                    ...
                    controller: _description..text = widget.olddescription,
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return "Field is required";
                      }
